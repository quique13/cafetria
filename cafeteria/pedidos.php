...
<div class="col-md-12 col-lg-12" >
	<div id="reportes" class="col-md-12 col-lg-12" >
			<center><table width="800" border="1" bordercolor="#000000" style="table-layout:fixed; font-size:10px" >
				<caption><center><font color="white">MENÚS DE LA SEMANA</font></center></caption>
				<tr bgcolor="#666666"> 
...
limit 5;";
	...
	while($row = mysql_fetch_array($result))
	{
		...
		$cadena.='<tr bgcolor="#333333"> 
				...
				<td width="350" height="25"    align="center" style="white-space: normal;" onMouseOver="this.style.background=\'#088A29\';" onMouseOut="this.style.background=\'\';" onClick="javascript:  Seleccion(\''.$row['fecha'].'\',\''.$row['dia'].'\',\''.$row['menu_1'].'\',\'1\',\''.$id_count.'\',\'guardar\') ;" style= "cursor:pointer;"><font color="white">'.$row['menu_1'].'</font></td>
				<td width="350" height="25"   align="center" style="white-space: normal;" onMouseOver="this.style.background=\'#088A29\';" onMouseOut="this.style.background=\'\';" onClick="javascript:  Seleccion(\''.$row['fecha'].'\',\''.$row['dia'].'\',\''.$row['menu_2'].'\',\'2\',\''.$id_count.'\',\'guardar\') ;" style= "cursor:pointer;"><font color="white">'.$row['menu_2'].'</font></td>
				</tr>
				<tr bgcolor="#680505">
